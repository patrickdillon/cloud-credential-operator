...
// Safe to remove this once go.sum shows only v0.49.0 or higher
...
replace github.com/openshift/api => github.com/barbacbd/api v0.0.0-20260902175613-7b09db073d4e
